  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass rounded-3xl p-8">
        ...
        >
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-secondary/40 to-secondary flex items-center justify-center mx-auto mb-4 shadow-[var(--shadow-accent)]">
      ...
      <div className="space-y-8 max-w-2xl fade-up stagger">
        ...
        <Tabs defaultValue="luma" className="space-y-6">
          <TabsList className="glass rounded-xl p-1 h-auto gap-1">
            <TabsTrigger
              value="luma"
              className="rounded-lg px-5 py-2 text-sm flex items-center gap-2 tap-pop data-[state=active]:text-primary data-[state=active]:bg-primary/10"
            >
